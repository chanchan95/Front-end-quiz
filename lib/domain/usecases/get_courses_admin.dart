...
class getCoursesAdmin{
  ...
  // }
  getCoursesAdmin({required ExamRepository examRepository}) : _examRepository = examRepository;

  Future<List<Course>> call(String sortKey, String sortValue) {
    return _examRepository.getCoursesAdmin(sortKey, sortValue);
  }
}